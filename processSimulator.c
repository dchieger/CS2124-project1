...
/* runProcess
 * input: the process name, a char** to save a return string to, and a pointer to an int that
 *        contains the number of steps to run for
 ...
 *
 * Attempts to run the process currently loaded in RAM for *pNumSteps time steps.
